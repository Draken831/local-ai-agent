<#
MSP AI Agent - Cloud First / Local Fallback v1.3.0
...
Write-Host "Downloading cloud-first v1.3.0 source..." -ForegroundColor Cyan
...
Write-Host ""
Write-Host "Cloud-first v1.3.0 install/update complete." -ForegroundColor Green
